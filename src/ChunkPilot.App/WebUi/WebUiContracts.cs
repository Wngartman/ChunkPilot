...
internal static class WebUiMethodPolicy
{
    private static readonly HashSet<string> Allowed = new(StringComparer.Ordinal)
    {
        ...
        "settings.saveGlobal", "settings.saveServer", "settings.curseforge.status", "settings.curseforge.save", "settings.curseforge.disconnect", "settings.curseforge.openConsole",
