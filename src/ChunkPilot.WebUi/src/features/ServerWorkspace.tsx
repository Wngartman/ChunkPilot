...
function ConnectivitySettings({ server }: { server: ServerSummary }) {
  ...
  return <div className={styles.connectivityPage}>
    ...
    <section className={styles.addressSection}><div className={styles.sectionHeading}><div><h3>How people connect</h3><p>Addresses follow the effective binding and current exact-owned listener; saved audience is separate.</p></div></div><ConnectionSummary server={server} connectivity={connectivity} showAll /></section>
    {connectivity.mode === 'PortForwarding' && <>
