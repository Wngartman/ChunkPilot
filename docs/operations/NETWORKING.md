...
is a separate elevated action. See [Windows Firewall access](../security/WINDOWS-FIREWALL-ACCESS.md) for the trust,
...
change. See [External reachability probe](../security/EXTERNAL-REACHABILITY-PROBE.md) for the API contract, the
