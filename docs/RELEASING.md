...
.\scripts\publish.ps1 -BuildInstaller -ReleaseTag v1.3.0-alpha.3
...
.\scripts\package-release.ps1 -ReleaseTag v1.3.0-alpha.3
.\scripts\test-portable-package.ps1 -PortableZip .\artifacts\release\v1.3.0-alpha.3\ChunkPilot-Portable-v1.3.0-alpha.3-win-x64.zip
git diff --check
```
