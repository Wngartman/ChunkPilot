...
- Microsoft SBOM Tool 4.1.5 is installed repository-locally from its verified NuGet package. Its telemetry output is written only to the ignored build-artifact directory; the tool states that no telemetry is submitted to Microsoft.
